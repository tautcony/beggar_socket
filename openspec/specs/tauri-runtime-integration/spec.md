...
Define the Tauri v2 desktop runtime integration requirements for the `web-client`, including native shell setup, runtime detection, window/security configuration, permissions, packaging, and Electron removal.
