...
Define the Rust-native platform service boundary so desktop-sensitive operations are implemented in `src-tauri` while the browser runtime remains first-class through shared frontend facades.
