...
enum {
    ...
    FAT16_CLUSTER_RAM_TYPE_DIR = 6,
    FAT16_CLUSTER_ROM_CFI_TXT = 7,
    FAT16_CLUSTER_ROM_CONFIG_TXT = 8,
    FAT16_CLUSTER_RAM_TYPE_SRAM_TXT = 9,
    FAT16_CLUSTER_RAM_TYPE_FRAM_TXT = 10,
    FAT16_CLUSTER_RAM_TYPE_FLASH_TXT = 11,
